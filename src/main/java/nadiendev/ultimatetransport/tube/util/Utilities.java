package nadiendev.ultimatetransport.tube.util;
...
public final class Utilities {
    ...
    public static void entityAccelerate(Entity entity, Direction direction) {
        Vec3 push = new Vec3(direction.getStepX() * 0.1, direction.getStepY() * 0.1, direction.getStepZ() * 0.1);
    ...
    public static void entityLimitSpeed(Entity entity) {
        ...
        entity.setDeltaMovement(
                Mth.clamp(motion.x, TubeConfig.maxSpeedInverse, TubeConfig.maxSpeed),
                Mth.clamp(motion.y, TubeConfig.maxSpeedInverse, TubeConfig.maxSpeed),
                Mth.clamp(motion.z, TubeConfig.maxSpeedInverse, TubeConfig.maxSpeed));
    }
    ...
    public static int tubeDirection(BlockGetter level, BlockPos pos) {
        ...
        return state.is(TubeRegistration.TUBE.get()) ? BlockTube.metaOf(state) : -1;
    }

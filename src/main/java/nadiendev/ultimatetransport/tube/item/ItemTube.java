package nadiendev.ultimatetransport.tube.item;
...
public class ItemTube extends BlockItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (direction == UNDIRECTED) {
            ...
            tooltip.add(Component.translatable("tooltip.ultimatetransport.autodirection.1").withStyle(ChatFormatting.GRAY));
            tooltip.add(Component.translatable("tooltip.ultimatetransport.autodirection.2").withStyle(ChatFormatting.DARK_GRAY));
            tooltip.add(Component.translatable("tooltip.ultimatetransport.autodirection.3").withStyle(ChatFormatting.DARK_GRAY));
            return;
        }
        tooltip.add(Component.translatable("tooltip.ultimatetransport.direction",
                Component.translatable("tooltip.ultimatetransport.direction." + direction).withStyle(ChatFormatting.AQUA))
